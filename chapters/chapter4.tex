...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{images/Synthetic Dataset Generation Workflow.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{images/Decision Tree Workflow.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{images/Training Pipeline.png}
