...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{images/High-Level System Architecture.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{images/User Interaction Sequence Diagram.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{images/Entity Relationship Diagram (ERD).png}
