...
\begin{figure}
    \centering
    \includegraphics[width=0.40\textwidth,height=0.60\textheight,keepaspectratio]{images/User Navigation Structure.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.60\textwidth,height=0.70\textheight,keepaspectratio]{images/Login page.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.40\textwidth,height=0.60\textheight,keepaspectratio]{images/Registration page.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.98\textwidth,height=0.8\textheight,keepaspectratio]{images/Result View 2.png}
