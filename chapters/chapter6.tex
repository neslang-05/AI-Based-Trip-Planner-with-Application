...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{images/Frontend Rendering Workflow.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{images/User Navigation Structure.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{images/Login page.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{images/Registration page.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{images/Destinatioj explorer.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{images/Trip Planning Form.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{images/Soft Delete Workflow.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{images/Result View 1.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{images/Result View 2.png}
