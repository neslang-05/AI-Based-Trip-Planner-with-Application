...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{images/Django MVT Architecture.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{images/Request Handling Workflow.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{images/Authentication Workflow.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{images/Itinerary Generation Pipeline.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{images/API Communication Architecture.png}
