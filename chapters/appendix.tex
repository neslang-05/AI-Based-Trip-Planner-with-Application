...
\begin{tcolorbox}[colback=blue!5, colframe=blue!50!black, title=Note]
The system is set up to look for static files in the \texttt{static} and \texttt{staticfiles} directories. If you make any CSS or JS changes, they will be loaded dynamically in development mode.
\end{tcolorbox}
