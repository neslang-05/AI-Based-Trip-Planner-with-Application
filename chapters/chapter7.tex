...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{images/Unit Testing Workflow.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{images/Integration Testing Architecture.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{images/Model Training and Evaluation Pipeline.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{images/Prediction Runtime Workflow.png}
