...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth,height=0.7\textheight,keepaspectratio]{images/Unit Testing Workflow.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth,height=0.65\textheight,keepaspectratio]{images/Model Training and Evaluation Pipeline.png}
